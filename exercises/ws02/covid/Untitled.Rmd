...
#merging the covid data into the dataset with the coords - apparently this can't be plotted (or takes an eternity)
dk_final<-
  dk_merge_coords%>%
  merge(df)
...
leaflet() %>%
  ...
  addPolygons(
    data = dk_merge_coords, color = "#444444", weight = 1, smoothFactor = 0.5,
