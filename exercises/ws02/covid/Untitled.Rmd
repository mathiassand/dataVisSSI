...
ch1_icon<-icons(
  iconUrl = ifelse(one_date$casesDPer100k < 0.20698220,    
    "rect_green.png", 
    "rect_red.png"
  ),
  iconWidth = one_date$dcr7dPer100kCh1 + 20, iconHeight= "10"
)
...
ch3_icon<-icons(
  ...
  iconWidth = one_date$dcr7dPer100kCh3 + 20, iconHeight= "10"
)
...
ch7_icon<-icons(
  ...
  iconWidth = one_date$dcr7dPer100kCh7 + 20, iconHeight= "10"
)
#values in dcr7dperk100kch are too small to get plottet - idk how to normalize

# still using dk_merge_coords to plot the data - dk_final not working yet
leaflet() %>%
  addTiles() %>%
  ...
  addPolygons(
    ...
    fillColor = ~ colorQuantile("YlOrRd", dcr7d)(dcr7d),
